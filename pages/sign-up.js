...
export default function SignUp() {  
  ...
  const signUpEP = async () => {
    ...
    const url = 'http://localhost:6767/sign-up';
    const data = {
      username: username,
      password: password,
    };
  ...
  return (
    <div>
      <Head>
        <title>Sign Up - NEA</title>
        <meta name="description" content="Create an account to start finding keywords." />
